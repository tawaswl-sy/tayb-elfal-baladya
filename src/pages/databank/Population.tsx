      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6 max-w-md">
        <div className="mb-6">
          ...
          <input
            ...
            min="0"
          />
          <p className="text-sm text-gray-500 mt-2">ملاحظة: لا يمكن أن يتجاوز مجموع سكان الأحياء هذا الرقم.</p>
        </div>
        
        <button
          onClick={handleSave}
          disabled={isLoading}
          className="w-full bg-[#1a3622] text-white px-4 py-2 rounded-lg flex items-center justify-center gap-2 hover:bg-[#2a4a32] transition-colors disabled:opacity-50"
        >
          <Save size={20} />
